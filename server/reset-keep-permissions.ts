...
async function resetKeepPermissions() {
  console.log('Starting database reset (keeping permissions)...');

  try {
    // Start a transaction to ensure data consistency
    await prisma.$transaction(async (tx) => {
      console.log('Deleting all data except permissions...');
